classdef ThreeFieldPlanar
    ...
    methods
        ...
        this.bar = reshape(this.bar, varargin{:});
        this.baz = reshape(this.baz, varargin{:});
        end
        
        function this = squeeze(this, varargin)
        %SQUEEZE Remove singleton dimensions.
        this.foo = squeeze(this.foo, varargin{:});
        this.bar = squeeze(this.bar, varargin{:});
        this.baz = squeeze(this.baz, varargin{:});
        end
        
        function this = circshift(this, varargin)
        %CIRCSHIFT Shift positions of elements circularly.
        this.foo = circshift(this.foo, varargin{:});
        this.bar = circshift(this.bar, varargin{:});
        this.baz = circshift(this.baz, varargin{:});
        end
        
        function this = permute(this, varargin)
        %PERMUTE Permute array dimensions.
        this.foo = permute(this.foo, varargin{:});
        this.bar = permute(this.bar, varargin{:});
        this.baz = permute(this.baz, varargin{:});
        end
        
        function this = ipermute(this, varargin)
        %IPERMUTE Inverse permute array dimensions.
        this.foo = ipermute(this.foo, varargin{:});
        this.bar = ipermute(this.bar, varargin{:});
        this.baz = ipermute(this.baz, varargin{:});
        end
        
        function this = repmat(this, varargin)
        %REPMAT Replicate and tile array.
        this.foo = repmat(this.foo, varargin{:});
        this.bar = repmat(this.bar, varargin{:});
        this.baz = repmat(this.baz, varargin{:});
        end
        
        function this = ctranspose(this, varargin)
        %CTRANSPOSE Complex conjugate transpose.
        this.foo = ctranspose(this.foo, varargin{:});
        this.bar = ctranspose(this.bar, varargin{:});
        this.baz = ctranspose(this.baz, varargin{:});
        end
        
        function this = transpose(this, varargin)
        %TRANSPOSE Transpose vector or matrix.
        this.foo = transpose(this.foo, varargin{:});
        this.bar = transpose(this.bar, varargin{:});
        this.baz = transpose(this.baz, varargin{:});
        end
        ...
        if nargin > 1
            ...
            [this.baz,nshifts] = shiftdim(this.baz);
        end
        end
        ...
        args = varargin;
        for i = 1:numel(args)
            if ~isa(args{i}, 'jl.test.code.ThreeFieldPlanar')
                args{i} = jl.test.code.ThreeFieldPlanar(args{i});
            end
        end
        out = args{1};
        ...
        function out = eq(a, b)
        %EQ == Equal.
        if ~isa(a, 'jl.test.code.ThreeFieldPlanar')
            a = jl.test.code.ThreeFieldPlanar(a);
        end
        if ~isa(b, 'jl.test.code.ThreeFieldPlanar')
            b = jl.test.code.ThreeFieldPlanar(b);
        end
        tf = a.foo == b.foo;
        ...
        propertyValsA = {a.foo a.bar a.baz};
        ...
        if nargin == 1
            ...
            propertyValsB = {b.foo b.bar b.baz};
    ...
    methods (Access=private)
        ...
        if ~isa(rhs, 'jl.test.code.ThreeFieldPlanar')
            rhs = jl.test.code.ThreeFieldPlanar(rhs);
        end
