function [names, details] = readdir(dirPath)
% Like DIR but better
%
% [names, details] = jl.readdir(path)
%
% Like DIR, but better: Doesn't include . and .. in the results. Returns the
% details as a table, and time values as datetimes.
%
% Path is the path to the directory to read.
%
% Don't pass '*' wildcards in path. It'll probably work, but it's not officially
% supported.
%
% Returns:
