classdef Statement < handle
    ...
    methods (Access = protected)
        function out = fetchAllResults(this, initialExecStatus)
            ...
            while true
                if isResultSetNext
                    ...
                    out.results(end+1) = jl.sql.Result(rs);
                else
                    ...
                    if updateCount == -1
                        ...
                        out.results(end+1) = jl.sql.Result(updateCount);
                    end
                end
        ...
        function out = fetchCurrentResultSet(this)
            ...
            log = logger.Logger.getLogger('jl.sql');
            jResultSet = this.jdbc.getResultSet();
            rsMeta = jl.sql.jdbc.RSMetaData(jResultSet.getMetaData());
